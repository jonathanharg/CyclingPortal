...
/**
 * This represents a given riders results in a race. The riders adjusted elapsed time, sprinters
 * points and mountain points over all stages and segments are recorded here.
 */
public class RaceResult implements Serializable {
  ...
  // A comparator which sorts RaceResults based on Adjusted Elapsed Time in ascending order. The
  ...
  // A comparator which sorts RaceResults based on Sprinters Points in descending order. The result
  // with the most points will come first.
  ...
  // A comparator which sorts RaceResults based on Mountain Points in descending order. The result
  // with the most points will come first.
  ...
  /**
   * A method to add a stage result to the race result. This is useful as a riders results in a race
   * is just a sum of their results in all a races stages. E.g. RaceResults = Stage1Result +
