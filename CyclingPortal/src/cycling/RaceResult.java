...
public class RaceResult{
	...
	protected static final Comparator<RaceResult> sortByAdjustedElapsedTime = (RaceResult result1, RaceResult result2) -> result1.getCumulativeAdjustedElapsedTime().compareTo(result2.getCumulativeAdjustedElapsedTime());
