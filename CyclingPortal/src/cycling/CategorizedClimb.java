...
/**
 * Categorised Climb class. This represents a type of Segment that has a stage,
 * location, type, average gradient and a length.
 */
public class CategorizedClimb extends Segment {
  ...
  /**
   * Constructor method that sets up the Categorised Climb with a stage, location,
   * type, average gradient and length.
   * 
